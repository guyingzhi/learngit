#include "decode_AFN0C_FN89_96.h"


int decode_afn0C_F89_F96(uchar *as_data, str_AFN0C0D_QX *astr_val, int *ai_step)
{
	...
	{
		astr_val->isnull[lc_i] = getdataformat09(p, &(astr_val->val[lc_i]), &li_step);
