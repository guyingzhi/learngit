...
int decode_AFN0D_UQX(uchar *as_data, str_AFN0C0D_QX *astr_val, int *ai_step)
{
    ...
    *ai_step = li_step;
    ...
    {
        astr_val->isnull[li_i] = getdataformat07(p, &(astr_val->val[li_i]), &li_step);
...
int decode_AFN0D_IQX(uchar *as_data, str_AFN0C0D_QX *astr_val, int *ai_step)
{
    ...
    *ai_step = li_step;
    ...
    for (li_i = 0; li_i < lc_n ; li_i++)
    {
        astr_val->isnull[li_i] = getdataformat25(p, &(astr_val->val[li_i]), &li_step);
        astr_val->val_time[li_i] = ldt_act_dt;
        li_res = after_time(&ldt_curve_dt, &ldt_act_dt , lc_permin * 60 );/* 计算当前数据点对应的时间 */
        ldt_curve_dt = ldt_act_dt;
        /*if (time_after_check(&ldt_act_dt, &lstr_now) == 0)*/
...
int decode_AFN0D_POWERQX(uchar *as_data, str_AFN0C0D_QX *astr_val, int *ai_step)
{
    ...
    *ai_step = li_step;
    ...
    for (li_i = 0; li_i < lc_n ; li_i++)
    {
        astr_val->isnull[li_i] = getdataformat13(p, &(astr_val->val[li_i]), &li_step);
        astr_val->val_time[li_i] = ldt_act_dt;
        li_res = after_time(&ldt_curve_dt, &ldt_act_dt , lc_permin * 60 );/* 计算当前数据点对应的时间 */
        ldt_curve_dt = ldt_act_dt;
        /*if (time_after_check(&ldt_act_dt, &lstr_now) == 0)*/
...
int decode_AFN0D_CODEQX(uchar *as_data, str_AFN0C0D_QX *astr_val, int *ai_step)
{
    ...
    *ai_step = li_step;
    ...
    for (li_i = 0; li_i < lc_n ; li_i++)
    {
        astr_val->isnull[li_i] = getdataformat11(p, &(astr_val->val[li_i]), &li_step);
        astr_val->val_time[li_i] = ldt_act_dt;
        li_res = after_time(&ldt_curve_dt, &ldt_act_dt , lc_permin * 60 );/* 计算当前数据点对应的时间 */
        ldt_curve_dt = ldt_act_dt;
        /*if (time_after_check(&ldt_act_dt, &lstr_now) == 0)*/
...
{
	 str_AFN0C0D_QX lstr_afn0D_UQX_val;
	...
	memset(& lstr_afn0D_UQX_val, 0, sizeof( lstr_afn0D_UQX_val));
     memset(& lstr_afn0D_UQX_val.isnull, DATA_ISNULL, sizeof( lstr_afn0D_UQX_val.isnull));

	li_ret = decode_AFN0D_UQX(ac_p,  & lstr_afn0D_UQX_val, ai_step);
...
{
	str_AFN0C0D_QX lstr_afn0D_IQX_val;
	...
	memset(& lstr_afn0D_IQX_val, 0, sizeof( lstr_afn0D_IQX_val));
      memset(& lstr_afn0D_IQX_val.isnull, DATA_ISNULL, sizeof( lstr_afn0D_IQX_val.isnull));

	li_ret = decode_AFN0D_IQX(ac_p, & lstr_afn0D_IQX_val, ai_step);
...
{
	str_AFN0C0D_QX lstr_afn0D_POWERQX_val;
	...
	memset(& lstr_afn0D_POWERQX_val, 0, sizeof( lstr_afn0D_POWERQX_val));
    memset(& lstr_afn0D_POWERQX_val.isnull, DATA_ISNULL, sizeof( lstr_afn0D_POWERQX_val.isnull));

	li_ret = decode_AFN0D_POWERQX(ac_p,& lstr_afn0D_POWERQX_val, ai_step);
...
{
	str_AFN0C0D_QX lstr_afn0D_CODEQX_val;
	...
	memset(& lstr_afn0D_CODEQX_val, 0, sizeof( lstr_afn0D_CODEQX_val));
    memset(& lstr_afn0D_CODEQX_val.isnull, DATA_ISNULL, sizeof( lstr_afn0D_CODEQX_val.isnull));

	li_ret = decode_AFN0D_CODEQX(ac_p, & lstr_afn0D_CODEQX_val, ai_step);
